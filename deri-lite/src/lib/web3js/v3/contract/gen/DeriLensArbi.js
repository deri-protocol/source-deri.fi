...
export class DeriLensArbi extends ContractBase {
  ...
  constructor(chainId, contractAddress, opts = {}) {
    super(chainId, contractAddress, deriLensArbiAbi)
    // for pool use
  ...
  // query
  async getInfo(pool_, account_=ADDRESS_ZERO, pvs=[]) {
    const res = await this._call('getInfo', [pool_, account_, pvs])
    return deleteIndexedKey(res)
  }
  async getLpInfo(pool_, account_=ADDRESS_ZERO) {
  ...
  async getTdInfo(pool_, account_=ADDRESS_ZERO) {
